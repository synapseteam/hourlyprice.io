...
export const translationEN = {
  ...
  reg: "ЄДРПОУ code",
  regPlaceholder: "enter ЄДРПОУ code",
  regError: "Full registration number required",
  login: "Login",
  successLogin: "You have successfully signed in",
  registration: "Registration",
  registrationCompany: "Company registration",
  successRegister: "You have successfully signed up",
  successRegisterCompany: "You have successfully registered a company",
...
export const translationUA = {
  ...
  reg: "Код ЄДРПОУ",
  regPlaceholder: "Введіть код ЄДРПОУ",
  regError: "Неправильний код ЄДРПОУ",
  namePlaceholder: "Введіть повне ім'я",
  login: "Логін",
  successLogin: "Ви усішно увійшли",
  registration: "Реєстрація",
  registrationCompany: "Реєстрація компанії",
  successRegister: "Ви успішно зареєструвались",
  successRegisterCompany: "Ви успішно зареєстрували компанію",
  ...
  registerCompany: "Реєструвати компанію",
